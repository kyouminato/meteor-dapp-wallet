...
Helpers.formatTransactionBalance = function(value, exchangeRates, unit) {
    ...
    if((unit === 'usd' || unit === 'eur' || unit === 'btc') &&
       exchangeRates && exchangeRates[unit]) {
        ...
        var price = new BigNumber(String(web3.fromWei(value, 'feather')), 10).times(exchangeRates[unit].price);
...
// TODO change it to the ens address
var ensAddress = '0x1023847120934109238561238941723003410329';
